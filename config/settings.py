...
SECRET_KEY = 'django-insecure-y@x!l==6hg4^hxx$(96iz#!o9hgqv()kr*(v8q&qnknvzv^ot+'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True


ALLOWED_HOSTS = ['127.0.0.1', 'arik1987as.pythonanywhere.com']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                #custom
                'app_settings.context_processors.global_settings',
